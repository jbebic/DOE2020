# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 16:21:04 2021
...
if __name__ == "__main__":
    ...
    if True: # the generation displacement "inner loop" "
        ...
        for ig, gen_ix in enumerate(area_gens_indices):
            ...
            # list_debug = [139,141]
            # for line_con_num in list_debug:
            for line_con_num in range(line_total_num):
                # print('Line contigency = %d' %line_con_num)
                print('Working on contingency number %d' %(line_con_num+1))
    ...
    if True:
        ...
        foutroot = 'changecase_apparentpower_debug'
        ...
        foutroot = 'changecase_busvoltage_debug'
